...
public enum ApiResponseStatus {
    ...
    DATA_INGESTION_DOWNLOAD_FAILED(1121, "Data ingestion download failed",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_NOT_EXISTS(1112, "Data ingestion not exists",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_RETRY_ONLY_FAILED(1113, "Only failed data ingestion can retry ingestion",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_NAME_REQUIRED(1114, "Data ingestion name is required",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_RETRY_ONLY_INGESTION_TARGET(1115, "Only ingestion target data ingestion can retry",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_SORT_BY_INVALID(1116, "Data ingestion sort field is invalid",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_SORT_DIR_INVALID(1120, "Data ingestion sort direction is invalid",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_FOLDER_ONLY_OPERATION(1116, "This operation is only for folder",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_PARENT_MUST_BE_FOLDER(1117, "Data ingestion parent must be folder",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_MOVE_CYCLE_NOT_ALLOWED(1118, "Data ingestion move cycle is not allowed",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_FOLDER_UPDATE_REQUIRED(1119, "Data ingestion folder update payload is empty",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_DELETE_FAILED(1122, "Data ingestion delete failed",HttpStatus.BAD_REQUEST),
    DATA_INGESTION_DELETE_IN_PROGRESS(1123, "Data ingestion deletion is in progress",HttpStatus.CONFLICT),
