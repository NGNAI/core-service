...
public enum ApiResponseStatus {
    ...
    INVALID_USER_SOURCE_VALUE(1142, "Invalid user source value", HttpStatus.BAD_REQUEST),
    ...
    NESTED_CHILD_VALUE_INVALID(1143, "Invalid nested child value!", HttpStatus.NOT_FOUND),
    ...
    USER_PHONE_NUMBER_VALUE_INVALID(1145, "User phone number is invalid", HttpStatus.BAD_REQUEST),
    ...
    ROOT_USER_NOT_EXIST(1144, "Root user not exists!", HttpStatus.NOT_FOUND),

    TOPIC_ID_NOT_EXISTS(1150, "Topic ID does not exist", HttpStatus.NOT_FOUND),
    ...
    NOTEBOOK_ID_NOT_EXISTS(1151, "Notebook ID does not exist", HttpStatus.NOT_FOUND),
    NOTEBOOK_TITLE_CAN_NOT_BE_NULL_OR_EMPTY(1152, "Notebook title cannot be null or empty", HttpStatus.BAD_REQUEST),
    INVALID_MESSAGE_PARENT_VALUE(1049, "Invalid message parent value", HttpStatus.BAD_REQUEST),

    INVALID_MESSAGE_PARENT_TYPE_CAN_NOT_BE_NULL_OR_EMPTY(1146, "Message parent type cannot be null or empty", HttpStatus.BAD_REQUEST),
    MESSAGE_PARENT_ID_CAN_NOT_BE_NULL_OR_EMPTY(1147, "Message parent id cannot be null or empty", HttpStatus.BAD_REQUEST),
    MESSAGE_TYPE_CAN_NOT_BE_NULL_OR_EMPTY(1148, "Message type cannot be null or empty", HttpStatus.BAD_REQUEST),
    MESSAGE_CONTENT_CAN_NOT_BE_NULL_OR_EMPTY(1149, "Message content cannot be null or empty", HttpStatus.BAD_REQUEST),
    ...
    UNAVAILABLE_FOR_LEGAL_REASONS(1155, "Unavailable for legal reasons", HttpStatus.UNAVAILABLE_FOR_LEGAL_REASONS),
