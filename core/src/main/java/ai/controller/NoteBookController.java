...
public class NoteBookController {
    ...
    @GetMapping()
    ResponseEntity<ApiResponseModel<List<NoteBookResponseDto>>> getAllByUserId(
            @Valid @ModelAttribute NoteBookFilterDto filterDto) {
    ...
    @PostMapping()
    ResponseEntity<ApiResponseModel<NoteBookResponseDto>> create(
            @Valid @RequestBody NoteBookCreateRequestDto requestDto) {
        return ResponseEntity.ok(
    ...
    ResponseEntity<ApiResponseModel<NoteBookResponseDto>> update(@PathVariable UUID noteBookId,
            @Valid @RequestBody NoteBookUpdateRequestDto requestDto) {
        return ResponseEntity.ok(
                ApiResponseModel.<NoteBookResponseDto>builder()
    ...
    ResponseEntity<ApiResponseModel<NoteBookResponseDto>> renameTitle(@PathVariable UUID noteBookId,
            @Valid @RequestBody NoteBookRenameTitleRequestDto requestDto) {
        return ResponseEntity.ok(
                ApiResponseModel.<NoteBookResponseDto>builder()
    ...
    ResponseEntity<ApiResponseModel<NoteBookResponseDto>> updateInstruction(@PathVariable UUID noteBookId,
            @Valid @RequestBody NoteBookUpdateInstructionRequestDto requestDto) {
        return ResponseEntity.ok(
                ApiResponseModel.<NoteBookResponseDto>builder()
    ...
    ResponseEntity<ApiResponseModel<List<NoteBookSourceResponseDto>>> getSources(@PathVariable UUID noteBookId,
        ...
        CustomPairModel<Long, List<NoteBookSourceResponseDto>> result = noteBookSourceService.getSources(noteBookId,
                pageNumber, pageSize);
        return ResponseEntity.ok(
    ...
    ResponseEntity<ApiResponseModel<NoteBookSourcePresignedUrlResponseDto>> getDownloadUrl(
        ...
        NoteBookSourcePresignedUrlResponseDto downloadUrl = noteBookSourceService.getSourceDownloadUrl(noteBookId,
                sourceId, expiresInSeconds);
        return ResponseEntity.ok(
    ...
    ResponseEntity<ApiResponseModel<List<MessageResponseDto>>> getMessageByNoteBookId(@PathVariable UUID noteBookId,
            @Valid @ModelAttribute MessageFilterDto filterDto) {
        CustomPairModel<Long, List<MessageResponseDto>> result = messageService.getAll(noteBookId,
                MessageParentType.NOTEBOOK, filterDto);
        return ResponseEntity.ok(
